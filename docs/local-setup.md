# SportBook local setup

Product overview is in the root [README](../README.md). This page is the engineer runbook: architecture, seed accounts, env, scripts, and the API map.
